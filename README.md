...
CPU-only Julia code for the paper “Kalman-Bucy Filtering with Randomized
Sensing: Fundamental Limits and Sensor Network Design for Field Estimation.”
No Python or CUDA is required.
